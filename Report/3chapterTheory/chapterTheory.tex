...
\begin{figure}
	...
	\begin{subfigure}[b]{0.3\textwidth}
	 	\includegraphics[width=5cm]{topo.jpg} \caption{}\label{fig:focused} \end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=5cm]{topob.jpg} \caption{}\label{fig:incidental} \end{subfigure}
		
		
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=5cm]{topoa.jpg} \caption{}\label{fig:bornDigital} \end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=5cm]{topoc.jpg} \caption{}\label{fig:bornDigital} \end{subfigure}
	\centering
